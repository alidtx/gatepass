...
namespace Modules\KeyControl\Http\Controllers;

use Illuminate\Contracts\Support\Renderable;
use Illuminate\Http\Request;
use Illuminate\Routing\Controller;
use Modules\KeyControl\Entities\KeyControl;
use App\Traits\ApiResponseTrait;
use Illuminate\Support\Facades\Auth;
use Modules\keyControl\Http\Requests\KeyControlRequest;
class KeyControlController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            $KeyControl=KeyControl::orderBy('id', 'desc')
            ->orderBy('id', 'desc')
            ->sortable();
